...
| crash                                | 崩溃               |                  |                  |
| create                               | 创建               |                  |                  |
| Cross Site Script (XSS)              | 跨站点脚本（漏洞） |                  |                  |
| crowdsourcing                        | 众包               |                  |                  |
...
| window                               | 窗口               |                  |                  |
| word                                 | 单词               | 字               |                  |
| workaround                           | 变通方案           | 临时修补措施     |                  |
| wrapper                              | 包装器             | 包装             |                  |
| What You See Is What You Get, WYSIWYG  | 所见即所得       |                  |                  |
| What You See Is What You Mean, WYSIWYM | 所见即所想       |                  |                  |
...
| Vulnerability Detection                                     | 漏洞挖掘                 |                    |  |
| Vulnerability Reproducibility                               | 漏洞可复现性             |                    |  |
| Vulnerability Exploitability                                | 漏洞可利用性             |                    |  |
| Vulnerability Discoverability                               | 漏洞可发现性             |                    |  |
| Cyber Range                                                 | 网络靶场                 |                    |  |
| Kill Chain                                                  | 杀伤链                   |                    |  |
| Common Vulnerability and Exposure, CVE                      | 通用漏洞及曝光           |                    |  |
| Common Vulnerability Scoring System, CVSS                   | 通用漏洞评分系统         |                    |  |
| Common Weakness Enumeration, CWE                            | 通用缺陷枚举             |                    |  |
| Common Weakness Scoring System, CWSS                        | 通用缺陷评分系统         |                    |  |
| Common Platform Enumeration, CPE                            | 通用平台枚举             |                    |  |
| Open Vulnerability and Assesment Language, OVAL             | 开放漏洞评估语言         |                    |  |
| Common Attack Pattern Enumeration and Classification, CAPEC | 常见攻击模式枚举和分类   |                    |  |
| Security Information and Event Management, SIEM             | 安全信息与事件管理       |                    |  |
| Threat Hunting                                              | 威胁狩猎                 | 威胁猎杀           |  |
| User Behavior Analytics, UBA                                | 用户行为分析             |                    |  |
| User and Entity Behavior Analytics, UEBA                    | 用户和实体行为分析       |                    |  |
| Security Operations Center, SOC                             | 安全运营中心             |                    |  |
| Security Operations, Analytics and Reporting, SOAR          | 安全运维分析与报告       | 安全运营分析与报告 |  |
| Security Orchestration, and Automated Response, SOAR        | 安全编排自动化与响应     |                    |  |
| Security Orchestration and Automation Platform, SOAP        | 安全编排自动化平台       |                    |  |
| Security Incident Response Platform, SIRP                   | 安全事件响应平台         |                    |  |
| Threat Intelligence Platform, TIP                           | 威胁情报平台             |                    |  |
...
| whale phishing                                              | 鲸钓                     |                    |  |
| smishing                                                    | 钓鱼短信                 | 短信欺诈           |  |
| voice phishing, vishing                                     | 钓鱼电话                 |                    |  |
| data leakage                                                | 数据泄漏                 |                    |  |
| information disclosure                                      | 信息泄漏                 |                    |  |
| information exposure                                        | 信息泄漏                 |                    |  |
| Open-source intelligence, OSINT                             | 开源情报                 |                    |  |
| Bug Bounty                                                  | 漏洞赏金                 | 漏洞奖励           |  |
| Security Response Center, SRC                               | 安全应急响应中心         |                    |  |
| session prediction                                          | 会话预测                 |                    |  |
| session hijacking                                           | 会话劫持                 |                    |  |
| session fixation                                            | 会话固定                 |                    |  |
| session riding                                              | 会话偷渡                 | CSRF               |  |
| XML External Entity, XXE                                    | XML 外部实体（注入攻击） |                    |  |
